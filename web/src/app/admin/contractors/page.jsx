...
export default function AdminContractorsPage() {
  ...
  useEffect(() => {
    ...
    if (!userData || userData.role !== 'class_a') {
      router.push('/auth/login');
    }
  }, [userData, authLoading, router]);

  useEffect(() => {
    if (!authLoading && userData && userData.role === 'class_a') {
      loadContractors();
    }
  ...
  return (
    <DashboardLayout navigation={navigation} title="Contractors Management">
      <div className="space-y-6">
        {/* Header */}
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Contractors Management</h1>
            <p className="text-gray-600">Manage contractors and assign work orders</p>
          </div>
          <div className="flex space-x-3">
            <Link href="/admin/contractors/assign-work">
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex flex-col gap-2 ml-4">
                        ...
                        {contractor.status === 'pending' && !contractor.verified && (
                          <Button
                            variant="success"
                            size="sm"
                        ...
                        {contractor.status === 'active' && (
                          <Link href={`/admin/contractors/assign-work?contractor=${contractor.id}`}>
