    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-4xl bg-white rounded-2xl shadow-2xl border-2 border-indigo-100 overflow-hidden flex flex-col md:flex-row">
          ...
          <div
            id="login-section"
            className="md:w-7/12 w-full p-8 bg-white fade-in fade-in-active"
          >
          ...
          <div
            id="brand-section"
            className="md:w-5/12 w-full bg-gradient-to-br from-indigo-600 via-blue-600 to-indigo-700 flex flex-col items-center justify-center text-center p-8 relative fade-in fade-in-active"
          >
